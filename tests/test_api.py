...
show("training modules", client.get("/training/modules"))
show("book training", client.post("/training/book", json={
    "operator_id": "OP-001", "module_id": "MOD-005",
...
show("task-time estimate (exact match likely)", client.post("/estimation/task-time", json={
    "task_type": "Excavation", "environmental_condition": "Clear", "terrain_type": "Hard Soil"
}))
show("task-time estimate (rare combo -> fallback)", client.post("/estimation/task-time", json={
